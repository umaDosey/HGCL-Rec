...
def ParseArgs():
	...
	parser.add_argument('--epoch', default=125, type=int, help='number of epochs')
	parser.add_argument('--decay', default=0.96, type=float, help='weight decay rate')
	parser.add_argument('--save_path', default='tem', help='file name to save model and training record')
	parser.add_argument('--latdim', default=32, type=int, help='embedding size')
	parser.add_argument('--hyperNum', default=8192, type=int, help='number of hyperedges')
	...
	parser.add_argument('--ssl_reg', default=5e-2, type=float, help='weight for ssl loss')
	parser.add_argument('--GSssl_reg', default=1e-4, type=float, help='weight for GS-ssl loss')
	parser.add_argument('--encode_epoch', default=20, type=int, help='number of epochs for encoding')
	parser.add_argument('--hyperk', default=1, type=int, help='number of epochs for encoding')
